  ...
  return (
    <div className="flex flex-col w-full relative min-h-screen">
      ...
      <div className="w-full flex flex-row h-full flex-shrink-0 relative">
        <div className={`lg:w-60 ${showMenu ? 'flex flex-col' : 'lg:flex flex-col hidden'} w-full h-full bg-[#121212] flex-shrink-0 overflow-y-auto fixed top-0 left-0 shadow lg:z-[10] z-[9]`}>
